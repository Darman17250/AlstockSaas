...
import { uploadSiteDocument } from '@/services/crm/site-document'

export const dynamic = 'force-dynamic'

/**
 * Upload d'un document de chantier. Route Handler (façade fine) : le fichier
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const doc = await uploadSiteDocument(ctx, { siteId: id, file })
    ...
    console.error('upload site document failed', e)
