/**
 * Contraintes des documents de chantier (images, PDF, bureautique).
 * Validées côté serveur avant l'envoi au stockage. Identiques aux documents
 * d'affaire (cf. `validation/deal-document.ts`).
 */
